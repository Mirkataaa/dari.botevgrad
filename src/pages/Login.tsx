    ...
    if (error) {
      toast({
        ...
        description: error.message === "Invalid login credentials"
          ? "Невалидни данни за вход. Проверете имейл и парола."
          : error.message === "Email not confirmed"
          ? "Имейлът не е потвърден. Проверете входящата си поща."
          : error.message,
      });
    } else {
    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Влезте в акаунта си, за да дарявате и коментирате</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          >
            ...
            {googleLoading ? "Влизане..." : "Вход с Google"}
          </Button>
